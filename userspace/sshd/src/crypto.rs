...
//! - Simple RNG for key generation (using getrandom syscall)
...
// ============================================================================
// Simple RNG using getrandom syscall
// ============================================================================
...
impl SimpleRng {
    ...
    pub fn fill_bytes(&mut self, dest: &mut [u8]) {
        if let Err(_) = getrandom(dest) {
            // Very basic fallback if getrandom fails

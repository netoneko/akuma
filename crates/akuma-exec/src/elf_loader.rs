...
fn compute_stack_top(brk: usize, has_interp: bool) -> usize {
    ...
    const MIN_MMAP_SPACE: usize = 0x40_0000_0000; // 256GB for large/dynamic binaries (JSC gigacage needs 128GB)
    const MAX_STACK_TOP: usize = 0x80_0000_0000; // 512GB — well within 48-bit VA (T0SZ=16)

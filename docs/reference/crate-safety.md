...
| | |
|---|---|
| enforced unsafe-free crates | **20 of 30** |
| code in those crates | **19,461 of 42,912** lines under `crates/` (45.4%) |
| `unsafe` sites across `crates/` | **340** (328 production), of which **0** are inside an enforced crate |

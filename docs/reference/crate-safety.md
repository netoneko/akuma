...
half landed as `akuma-locks-rw-cell`. **22 of 32 crates** forbid. The three
...
The run before this one (earlier on 2026-08-31) read `crates/` 304/293/11 and
...
`src/syscall/` (24 files, 11,505 lines) carries `#![forbid(unsafe_code)]` in its

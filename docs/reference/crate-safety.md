...
| | |
|---|---|
| enforced unsafe-free crates | **26 of 42** |
| code in those crates | **28,135 of 52,202** lines under `crates/` (53.9%) |
...
`unsafe` site anywhere. They moved to break the `src/syscall/` ↔ `src/vfs/`

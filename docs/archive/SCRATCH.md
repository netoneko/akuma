...
> **Note:** scratch has been removed as part of a codebase trimming effort (see `docs/TRIM_FAT_PART_2.md`). Git is now available via `apk add git`. This document is kept for historical reference.
